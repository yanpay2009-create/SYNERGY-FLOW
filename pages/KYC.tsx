...
export const KYC: React.FC = () => {
  const { user, kycStatus, updateKycStatus, updateUserSecurity, updateUserProfile, isSecurityUnlocked, setIsSecurityUnlocked } = useApp();
    ...
    if (videoRef.current && canvasRef.current) {
        ...
        if (context) {
            ...
            setTimeout(() => {
                ...
                setFormData(prev => ({
                    ...prev,
                    docNumber: docType === 'ID' ? '1-1002-XXXXX-XX-X' : 'AA1234567',
  ...
  const handleSubmitFinal = (e: React.FormEvent) => {
    ...
    if (docType === 'Passport' && hasWorkPermit && (!formData.workPermitNumber || !workPermitImage)) {
        alert("Please provide your Work Permit number and upload a photo.");
        return;
    }
             ...
             <div className="animate-in fade-in duration-500">
                {kycStatus === 'Pending' && (
                    <div className="text-center py-10 flex flex-col items-center">
                        ...
                        {user.email === "synergyflow.my@gmail.com" && (
