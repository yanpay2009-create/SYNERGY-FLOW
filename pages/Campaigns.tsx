...
import { ArrowLeft, Search, Copy, Check, Megaphone, Tag, Percent, Info, ExternalLink } from 'lucide-react';
              ...
              <div className="p-4 space-y-4">
                ...
                <div className="pt-2">
                  <button 
                    ...
                    className="w-full bg-synergy-blue text-white py-3 rounded-xl font-bold text-sm flex items-center justify-center space-x-2 hover:bg-synergy-dark transition active:scale-[0.98]"
                  >
