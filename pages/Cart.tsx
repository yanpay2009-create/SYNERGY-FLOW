...
export const Cart: React.FC = () => {
  const { cart, updateCartQuantity, removeFromCart, checkout, addresses, selectedAddressId, paymentMethod, applyCoupon, appliedCoupon, removeCoupon, getCartTotals, referrer, addReferrer, user, savedCards, selectedCardId, t, isLoggedIn } = useApp();
      ...
      <div className="sticky top-0 z-[100] bg-gray-50/80 dark:bg-gray-900/80 backdrop-blur-xl border-b border-gray-100/50 dark:border-gray-800/50 -mx-4 px-4 py-3 mb-6 transition-all">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-bold ml-2 text-gray-900 dark:text-white tracking-tight">Checkout</h1>
          </div>
        </div>
      </div>
